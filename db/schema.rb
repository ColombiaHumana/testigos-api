...
ActiveRecord::Schema.define(version: 2018_06_13_181834) do
  ...
  create_table "callcenter_users", force: :cascade do |t|
    t.string "email", default: "", null: false
    t.string "encrypted_password", default: "", null: false
    t.string "reset_password_token"
    t.datetime "reset_password_sent_at"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_callcenter_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_callcenter_users_on_reset_password_token", unique: true
  end
  ...
  create_table "coordinadores", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["email"], name: "index_coordinadores_on_email", unique: true
    t.index ["reset_password_token"], name: "index_coordinadores_on_reset_password_token", unique: true
    t.index ["user_id"], name: "index_coordinadores_on_user_id"
  end
  ...
  create_table "panel_users", force: :cascade do |t|
    t.string "email", default: "", null: false
    t.string "encrypted_password", default: "", null: false
    t.string "reset_password_token"
    t.datetime "reset_password_sent_at"
